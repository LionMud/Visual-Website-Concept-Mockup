...
const reportSections = [
	{
		...
		icon: '🎩',
		summary:
			'Explore the classic mafia movie style and iconic New York pizzeria branding. Learn how to blend dark, dramatic visuals with bold, simple color schemes for a unique pizza brand.',
	...
	},
	{
		...
		icon: '🗣️',
		summary:
			'Use playful mafia slang and storytelling to create a memorable brand voice. Engage customers with fun menu names, inside jokes, and interactive campaigns.',
	...
	},
	{
		...
		icon: '💻',
		summary:
			'Modern restaurant sites are immersive, mobile-first, and interactive. Use bold images, micro-animations, and one-page storytelling for a cinematic experience.',
	...
	},
	{
		...
		icon: '♿',
		summary:
			'Ensure your site is usable by everyone. Use strong color contrast, resizable text, keyboard navigation, and ARIA labels.',
...
export default function ReportViewer() {
	...
	return (
		<div
			className={styles.mafiaSection}
			style={{ maxWidth: 800, margin: '2rem auto' }}
		>
			<h1
				className={
					styles.neonTitle + ' neonGlow'
				}
				style={{
					textAlign: 'center',
					marginBottom: '2rem',
